...
public class Test {
    ...
    static void Dzip(){
        ...
        Clustering c=d.readData("test",10);
    ...
    static void LZ78(){
        ...
        lz.seq.add(new Event(3,5));
        lz.seq.add(new Event(1,7));
        lz.seq.add(new Event(2,9));
        lz.seq.add(new Event(3,10));
        lz.seq.add(new Event(1,15));
        lz.seq.add(new Event(2,17));
        lz.seq.add(new Event(3,18));
        lz.seq.add(new Event(1,20));
        lz.seq.add(new Event(2,22));
        lz.seq.add(new Event(4,29));
        lz.seq.add(new Event(2,30));
        lz.seq.add(new Event(5,32));
        lz.seq.add(new Event(2,39));
        double sz=lz.encode();
        lz.printDictionary();
        ...
        lzz.seq.add(new Event(1,2));
        lzz.seq.add(new Event(2,8));
        lzz.seq.add(new Event(1,11));
        lzz.seq.add(new Event(3,12));
        lzz.seq.add(new Event(1,19));
        lzz.seq.add(new Event(4,23));
        lzz.seq.add(new Event(5,24));
        sz=lzz.encode();
        lzz.printDictionary();
        System.out.println(sz);
